...
struct ParserError : std::exception {
	const std::vector<std::string> parsing_stack;
	const std::optional<std::string> message;
	const std::optional<std::tuple<size_t, size_t, std::string>> text;
	ParserError() = delete;
private:
	ParserError(std::vector<std::string> parsing_stack, std::optional<std::string> message, std::optional<std::tuple<size_t, size_t, std::string>> text);
